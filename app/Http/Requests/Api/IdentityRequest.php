...
class IdentityRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return match ($resource) {
            ...
            'employees' => [
                'employee_number' => [$required, 'string', 'max:255', Rule::unique('employees', 'employee_number')->ignore($id)],
            ...
            'role-permissions' => [
                'role_id' => [$usesPivotPath ? 'sometimes' : $required, 'uuid', Rule::exists('roles', 'id')],
                'permission_id' => [$usesPivotPath ? 'sometimes' : $required, 'uuid', Rule::exists('permissions', 'id')],
